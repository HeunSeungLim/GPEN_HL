...
if __name__ == '__main__':
    ...
    parser.add_argument('--path', type=str, default='./datasets/gt', required=False)
    parser.add_argument('--LQ_path', type=str, default='./datasets/input', required=False)
    ...
    dataset = FaceDataset(args.path, args.size, args.LQ_path)
